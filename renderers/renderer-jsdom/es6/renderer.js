    ...
    return new bluebird_1.default((resolve, reject) => {
        ...
        async function captureDocument() {
            if (options.renderAfterDelay > 0) {
                await bluebird_1.default.delay(options.renderAfterDelay | 0);
            }
            const result = {
